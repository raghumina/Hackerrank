...
#
# Test Case 0:
# Because , our code must set  to  and print the "Age is not valid...
# " message followed by the young message. Three years pass and , so we print the young message again.
#
# Test Case 1:
...
# test case's expected output. If you're failing this challenge
